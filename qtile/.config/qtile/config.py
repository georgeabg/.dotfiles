...
term = "alacritty"  # Setting terminal
...
keys = [
    ...
    Key([mod], "w", lazy.spawn("brave"), desc="Launches browser"),
    Key([mod], "y", lazy.spawn("rofimoji -a copy"), desc="Launches rofimoji"),
    Key(
        [mod, "shift"],
        "p",
        lazy.spawn(os.path.expanduser("~/.config/rofi/bin/menu_powermenu")),
        desc="Rofi powermenu",
    ),
    Key(
        [mod, "shift", "control"],
